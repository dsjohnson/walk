...
ctmc_n2ll_arma <- function(id, dt, L, ns, from_to, Xb_q_r, Xb_q_m, delta, row_sweep = TRUE) {
    .Call(`_walk_ctmc_n2ll_arma`, id, dt, L, ns, from_to, Xb_q_r, Xb_q_m, delta, row_sweep)
}
